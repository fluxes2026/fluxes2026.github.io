...
4. Add `remote_theme: "halt9k/greenhouse-gas-fluxes-2026@v4.0.4"` to your `_config.yml` file. Remove any other `theme:` or `remote_theme:` entry.

   ```yaml
   remote_theme: "halt9k/greenhouse-gas-fluxes-2026@v4.0.4"
   ```
